-- ОПРЕДЕЛЕНИЕ СЕРВИСОВ И ПЕРЕМЕННЫХ (Это то, чего не хватало)
local Players = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
local player = Players.LocalPlayer

-- Глобальная переменная для работы цикла (чтобы он не выдавал ошибку)
_G.TabInjected = true 
